...
function calcularCuotas() {
    ...
    document.getElementById('saldo_financiar').textContent = formatearNumero(saldoFinanciar);
    document.getElementById('valor_cuota').textContent = formatearNumero(valorCuota);
